...
/*    public HashMap<String, StatCollector> stats = new HashMap<String, StatCollector>();*/
    ...
    public void onEnable() {
        ...
        }, this).setOption(2, new ItemStack(Material.REDSTONE, 1), ChatColor.DARK_RED + "" + ChatColor.BOLD + Localizers.getDefaultLoc().SETSPAWN_RED_LOBBY.getString() + ChatColor.RESET,
                ChatColor.WHITE + Localizers.getDefaultLoc().SETSPAWN_RED_LOBBY_DESC.getString()).setOption(3, new ItemStack(Material.INK_SACK, 1, (short) 4),
                ChatColor.AQUA + "" + ChatColor.BOLD + Localizers.getDefaultLoc().SETSPAWN_BLUE_LOBBY.getString() + ChatColor.RESET,
                ChatColor.WHITE + Localizers.getDefaultLoc().SETSPAWN_BLUE_LOBBY_DESC.getString()).setOption(4, new ItemStack(Material.WOOL, 1, (short) 14),
                ChatColor.DARK_RED + "" + ChatColor.BOLD + Localizers.getDefaultLoc().SETSPAWN_RED_SPAWN.getString() + ChatColor.RESET,
                ChatColor.WHITE + Localizers.getDefaultLoc().SETSPAWN_RED_SPAWN_DESC.getString()).setOption(5, new ItemStack(Material.WOOL, 1, (short) 11),
                ChatColor.AQUA + "" + ChatColor.BOLD + Localizers.getDefaultLoc().SETSPAWN_BLUE_SPAWN.getString() + ChatColor.RESET,
                ChatColor.WHITE + Localizers.getDefaultLoc().SETSPAWN_BLUE_SPAWN_DESC.getString()).setOption(6, new ItemStack(Material.BEDROCK, 1),
                ChatColor.RED + "" + ChatColor.BOLD + Localizers.getDefaultLoc().SETSPAWN_EXIT.getString() + ChatColor.RESET, ChatColor.RED + Localizers.getDefaultLoc().SETSPAWN_EXIT_DESC.getString());
