...
/*        if (dc.lobbyWallHasBeenSet()) {
        ...
        /*if (dc.atLeastOneClassChestDefined()) {
            cs.sendMessage(ChatColor.GREEN + "At least one class defined? " + ChatColor.DARK_GREEN + "Yes. " + ChatColor.GRAY + "(" + ChatColor.DARK_GREEN + ChatColor.GRAY + ")"); //+ dc.getClassChests()
        } else {
